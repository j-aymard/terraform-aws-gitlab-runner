...
echo "yum install -y amazon-efs-utils" >> /home/ec2-user/userdata.sh
echo "apt-get -y install amazon-efs-utils" >> /home/ec2-user/userdata.sh
echo "yum install -y nfs-utils" >> /home/ec2-user/userdata.sh
echo "apt-get -y install nfs-common" >> /home/ec2-user/userdata.sh
